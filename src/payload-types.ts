...
export interface Order {
   ...
   */
  amount: number;
  transactionType?: ('new_purchase' | 'upgrade' | 'crossgrade' | 'renewal') | null;
  /**
...
export interface LicenseTransaction {
  ...
  transactionType: 'new_purchase' | 'upgrade' | 'crossgrade' | 'renewal';
...
export interface CommerceOffer {
   ...
   */
  allowedFromProducts?: (number | Product)[] | null;
  /**
