  ...
  return (
    <PolicyPage title="Terms and Conditions" cmsContent={cmsContent}>
      ...
      <ul>
        ...
        <li>
          <strong>Major Upgrades:</strong> If a major version (e.g., 2.0) is released within six (6)
          months of your purchase date, you are eligible for a free upgrade to that new version.
