...
export default async function RefundPolicyPage() {
  ...
  return (
    <PolicyPage title="Refund Policy" cmsContent={cmsContent}>
      ...
      <ul>
        <li>
          The software has a major confirmed bug that we are unable to fix in a timely manner.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          The software does not meet your personal preferences or workflow, if it otherwise
          functions as technically described.
        </li>
        <li>
