          ...
          fields: [
            {
              ...
              type: 'textarea',
              defaultValue:
                'Build, arrange, and perform with MXGRID—a powerful music creation suite built for seamless beat-making and fluid loop sequencing. From raw samples to finished tracks, shape your sound with total precision.',
              label: 'Intro text',
            },
            {
              type: 'row',
